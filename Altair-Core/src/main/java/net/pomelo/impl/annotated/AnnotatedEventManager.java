package net.pomelo.impl.annotated;

import net.pomelo.EventManager;
import net.pomelo.dispatch.EventDispatcher;
import net.pomelo.handler.EventHandler;
import net.pomelo.handler.scan.EventHandlerScanner;
import net.pomelo.impl.annotated.dispatch.MethodEventDispatcher;
import net.pomelo.impl.annotated.handler.scan.MethodHandlerScanner;
 ...
 * with the {@link net.pomelo.impl.annotated.handler.annotation.Listener}
 * annotation.
 *
 * @author Daniel
 * @since May 31, 2017
